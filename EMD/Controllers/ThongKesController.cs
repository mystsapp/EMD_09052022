...
namespace EMD.Controllers
{
    public class ThongKesController : Controller
    {
        ...
        [HttpPost]
        public IActionResult TheoNgayDC(string tuNgay, string denNgay)
        {
            DateTime tu = Convert.ToDateTime(tuNgay);
            DateTime den = Convert.ToDateTime(denNgay);
            byte[] fileContents;
            ...
            if (tu == den)
            {
                xlSheet.Cells[3, 1].Value = "CAC DOAN CO NGAY DAT COC TU " + tu.ToString("dd/MM/yyyy");
            }
            else
            {
                xlSheet.Cells[3, 1].Value = "CAC DOAN CO NGAY DAT COC TU " + tu.ToString("dd/MM/yyyy") + " DEN " + den.ToString("dd/MM/yyyy");
            }
            ...
            DataTable dt = _unitOfWork.emdRepository.TheoNgayDC_Report(tuNgay, denNgay);
           ...
           // setBorder(dong, 5, dong, 15, xlSheet);
            ...
            try
            {
                ...
                fileContents: fileContents,
                contentType: "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet",
                fileDownloadName: "TheoNgayDC_" + System.DateTime.Now.ToString("dd/MM/yyyy HH:mm") + ".xlsx");
        ...
        [HttpPost]
        public IActionResult TheoNgayHetHan(string tuNgay, string denNgay)
        {
            DateTime tu = Convert.ToDateTime(tuNgay);
            DateTime den = Convert.ToDateTime(denNgay);
            byte[] fileContents;
            ...
            if (tu == den)
            {
                xlSheet.Cells[3, 1].Value = "CAC DOAN CO NGAY HET HAN TU " + tu.ToString("dd/MM/yyyy");
            }
            else
            {
                xlSheet.Cells[3, 1].Value = "CAC DOAN CO NGAY HET HAN TU " + tu.ToString("dd/MM/yyyy") + " DEN " + den.ToString("dd/MM/yyyy");
            }
            ...
            DataTable dt = _unitOfWork.emdRepository.TheoNgayHetHan_Report(tuNgay, denNgay);
           ...
           // setBorder(dong, 5, dong, 15, xlSheet);
            ...
            try
            {
                ...
                fileContents: fileContents,
                contentType: "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet",
                fileDownloadName: "TheoNgayHetHan_" + System.DateTime.Now.ToString("dd/MM/yyyy HH:mm") + ".xlsx");
        ...
        [HttpPost]
        public IActionResult TheoDoiTuongBK(string tuNgay, string denNgay)
        {
            DateTime tu = Convert.ToDateTime(tuNgay);
            DateTime den = Convert.ToDateTime(denNgay);
            byte[] fileContents;
            ...
            DataTable dt = _unitOfWork.emdRepository.TheoDoiTuongBK_NgayBay_Report(tuNgay, denNgay);
        ...
        public IActionResult TheoDoanChuaHC(string tuNgay, string denNgay)
        {
            DateTime tu = Convert.ToDateTime(tuNgay);
            DateTime den = Convert.ToDateTime(denNgay);
            byte[] fileContents;
            ...
            if (tu == den)
            {
                xlSheet.Cells[3, 1].Value = "CAC DOAN CHUA HOAN COC NGAY BAY TU " + tu.ToString("dd/MM/yyyy");
            }
            else
            {
                xlSheet.Cells[3, 1].Value = "CAC DOAN CHUA HOAN COC NGAY BAY TU " + tu.ToString("dd/MM/yyyy") + " DEN " + den.ToString("dd/MM/yyyy");
            }
            ...
            DataTable dt = _unitOfWork.emdRepository.TheoDoanChuaHoanCoc_Report(tuNgay, denNgay);
            ...
            try
            {
                ...
                fileContents: fileContents,
                contentType: "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet",
                fileDownloadName: "TheoDoanChuaHC_" + System.DateTime.Now.ToString("dd/MM/yyyy HH:mm") + ".xlsx");
